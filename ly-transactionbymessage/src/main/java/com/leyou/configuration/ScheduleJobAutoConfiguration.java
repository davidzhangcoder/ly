...
import com.leyou.service.impl.TransactionalMessageManagementService;
...
public class ScheduleJobAutoConfiguration {
    ...
    public ScheduleJobAutoConfiguration(TransactionalMessageManagementService managementService) {
    ...
    private Logger log = LoggerFactory.getLogger(ScheduleJobAutoConfiguration.class);
