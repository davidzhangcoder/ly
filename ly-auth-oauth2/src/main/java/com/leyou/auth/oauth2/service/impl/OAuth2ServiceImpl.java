package com.leyou.auth.oauth2.service.impl;
...
public class OAuth2ServiceImpl implements OAuth2Service {
    ...
    public AuthToken authorize(String username, String password, String clientId , String clientSecret, String grantType) {
        ...
        //选中认证服务的地址
        ServiceInstance serviceInstance = loadBalancerClient.choose("auth-oauth2-service");
        if (serviceInstance == null) {
            throw new RuntimeException("找不到对应的服务");
        }
        //获取令牌的url
        String path = serviceInstance.getUri().toString() + "/uaa/oauth/token";
        //定义body
